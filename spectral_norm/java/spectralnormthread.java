...
public class spectralnormthread
{
    ...
    public static void main (String[] args)
    {
        ...
        System.out.println (formatter.format (spectralnormthreadGame (n)) );
    }
    
    
    private static final double spectralnormthreadGame (int n)
    {
        // create unit vector
